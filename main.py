    """
    Tree Viewer W75ui0t6
    ====================
    Developer-friendly CLI that helps you audit projects in seconds.
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-friendly CLI that helps you audit projects in seconds.")
